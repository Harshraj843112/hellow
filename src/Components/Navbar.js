      ...
      <div className="md:flex items-center justify-between bg-gray-900 py-2 md:px-10 px-7 ">
        <div className="font-bold text-2xl cursor-pointer flex items-center justify-between md:justify-start gap-1 ">
          <NavLink to="/" className="link">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSsHCzcmpFlnL2ptIAqpHeX1EX9e4GvhbUUNA&usqp=CAU"
              className="h-16 md:h-20 w-auto max-w-full transition duration-300 transform hover:scale-110 relative z-10"
              alt="Logo"
            />
          </NavLink>
        </div>
        ...
        <ul
          className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-gray-900 md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${
            open ? "top-12" : "top-full md:top-0"
          }`}
        >
          <NavLink to="/website-service-solution">
